...
VALUES ('Squats are a functional exercise that benefit your joint and muscle health, as well as your posture',
...
INSERT INTO public.exercise (description, image, name, target_muscle_group, vid_link)
VALUES ('The abdominal muscles used to hold the body rigid during the push-up are the rectus abdominis and the internal and external obliques.',
...
INSERT INTO public.exercise (description, image, name, target_muscle_group, vid_link)
VALUES ('Hold a dumbbell with one hand along the side of your body.',
...
INSERT INTO public.profile (set_id, user_id, goal_id, address_id, program_id, workout_id, disabilities, height,
                            medical_conditions, weight)
VALUES (1,
        'Alice',
        1,
        1,
...
VALUES ('2022-03-20T12:45:00.000+00:00',
        1,
        2);
